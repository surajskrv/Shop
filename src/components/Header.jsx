...
export default function Header() {
  ...
  return (
    <header className="bg-steel text-white sticky top-0 z-50 backdrop-blur bg-steel/95 shadow-lg">
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="md:hidden border-t border-white/10 bg-steel/95 backdrop-blur"
         >
