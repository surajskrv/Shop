    ...
    <footer className="bg-steel text-white py-8 px-4 mt-12">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-4 text-2xl">
          <a href="#" aria-label="Facebook" className="hover:text-safety"><i className="fab fa-facebook"></i></a>
          <a href="#" aria-label="Instagram" className="hover:text-safety"><i className="fab fa-instagram"></i></a>
          <a href="#" aria-label="LinkedIn" className="hover:text-safety"><i className="fab fa-linkedin"></i></a>
        </div>
      </div>
